...
export default function LoginPage() {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            fetch('https://v1.test.socket.araby.ai/login', {
                cache: 'no-store',
                method: 'POST', 
    ...
    return (
        <main className="flex-1 flex items-center justify-center w-full">
            <div className="flex flex-col text-black bg-white shadow-xl rounded-xl py-8 px-5 w-full lg:max-w-[500px] max-w-[450px] ">
                <h1 className="text-xl text-center mb-8 sm:text-2xl">Login</h1>
                <form className="flex flex-col" onSubmit={onSubmit}>
                    ...
                    <div className="relative my-6">
                        <button className="w-full text-white rounded-lg bg-blue-600 hover:bg-blue-800 py-2">Login</button>
